export default function Header() {
  return (
    <>
      {/*  START Header  */}
  <header className="bg-dark border-b border-dark-border relative z-50 overflow-visible">
    ...
    <div className="max-w-[1800px] mx-auto relative px-0 md:px-6">
      ...
      <div className="flex md:hidden items-center justify-between w-full py-3 px-4 gap-3 bg-dark z-50 relative">
        {/*  Logo  */}
        <div
          className="w-10 h-10 rounded-full bg-gradient-to-br from-green-400 via-purple-500 to-blue-500 flex items-center justify-center p-[2px] shrink-0">
      ...
      <div className="hidden md:flex items-center justify-between py-4" id="top-header-search">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <div
            className="w-10 h-10 rounded-full bg-gradient-to-br from-green-400 via-purple-500 to-blue-500 flex items-center justify-center text-white font-bold text-xl p-[2px]">
        ...
        <div className="flex-1 max-w-4xl mx-8">
          <div className="search-glow-container">
            <div className="search-input-box rounded-full flex items-center px-4 py-2.5">
              ...
              <input type="text" placeholder="Search for products, pages and posts ..."
                className="bg-transparent w-full focus:outline-none text-sm text-white placeholder-gray-500" />
            </div>
          </div>
        </div>
      ...
      <div className="hidden md:flex items-center py-2 border-t border-dark-border relative" id="bottom-header-menu">
        ...
        <nav className="flex items-center gap-6 ml-8 overflow-x-auto no-scrollbar w-full">
          ...
          <a href="#" className="nav-link"><span className="text-yellow-500">⏳</span> Flash Deals <span
              className="badge-new">NEW</span></a>
          ...
          <a href="#" className="nav-link"><span className="text-gray-400">⚙️</span> Elegoo <span
              className="badge-new">NEW</span></a>
        </nav>
      </div>

      <nav
          className="flex md:hidden items-center gap-6 px-4 py-3 overflow-x-auto no-scrollbar border-b border-dark-border flex-shrink-0">
          <a href="#" className="nav-link"><span className="text-blue-300">⛄</span> Winter Special</a>
          <a href="#" className="nav-link"><span className="text-red-500">⚡</span> Specials</a>
          <a href="#" className="nav-link"><span className="text-blue-400">💻</span> Laptops Special</a>
          <a href="#" className="nav-link">Components</a>
      ...
      <div id="megaMenu"
        ...
        <div id="mobileGrid" className="flex-1 md:hidden p-4">
          ...
          <div className="bg-[#131317] rounded-full flex p-1 mb-6">
            <button
              className="flex-1 rounded-full bg-dark text-white py-2 flex items-center justify-center gap-2 text-sm font-semibold shadow-md"><span
                className="text-cyan-400">⊞</span> Zones</button>
            <button className="flex-1 py-2 text-gray-500 flex items-center justify-center gap-2 text-sm font-semibold"><span
                className="text-orange-500">★</span> Faves</button>
          </div>
        ...
        <div className="hidden md:flex w-full">
          ...
          <div className="w-80 border-r border-dark-border flex flex-col shrink-0 bg-[#0c0c0e]">
            ...
            <div className="flex items-center border-b border-dark-border">
              <button
                className="flex-1 py-4 flex items-center justify-center gap-2 text-cyan-400 border-b-2 border-cyan-400 font-semibold text-sm bg-[#131317]">
              ...
              <button
                className="flex-1 py-4 flex items-center justify-center gap-2 text-gray-400 font-semibold text-sm hover:text-white transition-colors">
  ...
  <div
    className="md:hidden fixed bottom-0 left-0 w-full h-[60px] bg-dark border-t border-dark-border flex items-center justify-between px-6 z-50">
