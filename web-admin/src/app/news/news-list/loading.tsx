  ...
  return (
    <div className="flex flex-col h-full w-full p-2 animate-in fade-in duration-300">
      <div className="flex flex-col flex-1 h-full min-h-0 space-y-4">
        ...
        {/* Table Skeleton */}
        <div className="flex-1 glass-panel rounded-lg animate-pulse bg-[#0a0a0f]/40 flex flex-col justify-between">
          ...
          <div className="h-14 border-t border-gray-800 bg-gray-950/50 mt-auto" />
        </div>
      </div>
    </div>
  );
