...
import { AddFrameProductModal } from './AddFrameProductModal';

export function ProductFrameProductFilter() {
  ...
  return (
    <div className="flex flex-col gap-4 mb-4">
      ...
      <AddFrameProductModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
    </div>
  );
}
